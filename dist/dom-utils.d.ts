// Generated by dom-utils build script
 ...
 */
function getClosestHtmlEl(el: Element | null, selector: string, depth?: number): HTMLElement | null;
/**
 ...
 */
function getParentHtmlEl(el: HTMLElement): HTMLElement | null;
/**
 ...
 */
function getSiblingHtmlEl(el: HTMLElement): HTMLElement | null;
/**
 ...
 */
function getSiblings(el: HTMLElement, selector?: string): HTMLElement[];
/**
 ...
 */
function getNextElsUntil(elementOrSelector: Element | string, boundarySelector: string, filterSelector?: string): Element[];
/**
 ...
 * @returns {Element[]} Array of matching elements.
 */
function getPrevElsUntil(elementOrSelector: Element | string, boundarySelector: string, filterSelector?: string): Element[];
/**
 ...
 */
function getLastHtmlEl(selector: string): HTMLElement | null;
/**
 ...
 */
function directQuerySelector(el: HTMLElement, selector: string): HTMLElement | null;
/**
 ...
 * @returns {void}
 */
function forEachEl(selector: string | NodeListOf<Element> | HTMLElement[], handler: (el: Element) => void): void;
/**
 ...
 */
function getAttr(selector: HTMLElement | string, key: string): string;
/**
 ...
 */
function getAttrAsNumber(selector: HTMLElement | string, key: string): number;
/**
 ...
 * @returns {void}
 */
function updateElSrc(el: HTMLElement | Element, src: string): void;
/**
 ...
 */
function getPureHeight(el: HTMLElement): number;

}

export as namespace DomUtils;
export = DomUtils;
